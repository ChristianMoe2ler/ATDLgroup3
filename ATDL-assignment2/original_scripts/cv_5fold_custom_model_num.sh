...
#
# Usage:
#   bash run_5_fold_experiments2.sh [--dry-run]
#
################################################################################
...
N_FOLDS=5
SEED=42
MODEL_NUM=5        # Number of MLP heads in ensemble (default is 10)
DRY_RUN=false
...
echo "  MLP heads in ensemble: ${MODEL_NUM}"
echo "=========================================="
...
do
    ...
    sed -e "s|\"training_path\": \".*\"|\"training_path\": \"${TRAIN_DIR}\"|g" \
        ...
        -e "s|\"model_num\": [0-9]*|\"model_num\": ${MODEL_NUM}|g" \
